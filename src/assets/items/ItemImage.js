  ...
  armor: {
    heavy: {
      set1: {
        ...
        glove: heavyArmorImages[5],
        helmet: heavyArmorImages[6],
        pants: heavyArmorImages[8],
      },
      set2: {
        belt: heavyArmorImages[0],
        boots: heavyArmorImages[1],
        chest: heavyArmorImages[3],
        glove: heavyArmorImages[5],
        helmet: heavyArmorImages[7],
        pants: heavyArmorImages[9],
      },
    },
    ...
    light: {
      ...
      set2: {
        belt: heavyArmorImages[0],
        boots: lightArmorImages[0],
        chest: lightArmorImages[2],
        glove: lightArmorImages[4],
        helmet: lightArmorImages[6],
        pants: lightArmorImages[8],
      },
      set3: {
        belt: heavyArmorImages[0],
        boots: lightArmorImages[0],
        chest: lightArmorImages[3],
        glove: lightArmorImages[4],
        helmet: lightArmorImages[7],
        pants: lightArmorImages[8],
      },
    },
  },
